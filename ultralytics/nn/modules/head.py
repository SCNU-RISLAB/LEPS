...
from .block import DFL, Proto, Proto4_new_add_dw, Proto4_solo, Proto3_solo, Proto5_solo
...
class Segment(Detect):
    ...
    def __init__(self, nc=80, nm=32, npr=256, ch=()):
        ...
        #self.proto = Proto(ch[0], self.npr, self.nm)  # protos  #修改前
        #self.proto = Proto4_new_add_dw(c_in=(ch[0], ch[1], ch[2]), c_=self.npr, c2=self.nm)  # protos  #修改后1  #42、43
        #self.proto = Proto3_solo(c_in=(ch[0], ch[1], ch[2]), c_=self.npr, c2=self.nm)  # protos  #修改后2   #44、45
        self.proto = Proto4_solo(c_in=(ch[0], ch[1], ch[2]), c_=self.npr, c2=self.nm)  # protos  #修改后3
        #self.proto = Proto5_solo(c_in=(ch[0], ch[1], ch[2]), c_=self.npr, c2=self.nm)  # protos  #修改后4
    ...
    def forward(self, x):
        ...
        #p = self.proto(x[0])  # mask protos  #修改前
        p = self.proto(x)  # mask protos #修改后1、2、3
